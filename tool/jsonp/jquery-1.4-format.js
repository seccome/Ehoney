(function(A, w) {
    ...
    function T(a) {
        for (var b = 0,
        d, f; (d = a[b]) != null; b++) if (!c.noData[d.nodeName.toLowerCase()] && (f = d[H])) delete c.cache[f]
    }
    function L(a, b) {
        var d = {};
    ...
    c.fn.extend({
        ...
        toggleClass: function(a, b) {
            ...
            return this.each(function() {
                ...
                j = c(this), o = b, p = a.split(fa); e = p[i++];) {
                    o = f ? o: !j.hasClass(e);
        ...
        hasClass: function(a) {
            a = " " + a + " ";
            for (var b = 0,
            d = this.length; b < d; b++) if ((" " + this[b].className + " ").replace(za, " ").indexOf(a) > -1) return true;
            return false
        },
        val: function(a) {
            if (a === w) {
    ...
    function() {
        ...
        p.filter = function(g, h, k, m) {
            for (var r = g,
            q = [], v = h, u, y, S = h && h[0] && x(h[0]); g && h.length;) {
            ...
            find: {
                ...
                NAME: function(g, h) {
                    if (typeof h.getElementsByName !== "undefined") {
                        ...
                        for (var m = 0,
                        r = h.length; m < r; m++) h[m].getAttribute("name") === g[1] && k.push(h[m]);
        ...
        domManip: function(a, b, d) {
            ...
            if (this[0]) {
                ...
                if (i = e.fragment.firstChild) {
                    b = b && c.nodeName(i, "tr");
                    for (var p = 0,
                    n = this.length; p < n; p++) d.call(b ? f(this[p], i) : this[p], e.cacheable || this.length > 1 || p > 0 ? e.fragment.cloneNode(true) : e.fragment)
                }
                o && c.each(o, La)
            }
            return this
    ...
    c.extend({
        ...
        ajax: function(a) {
            ...
            function f(r, q) { (e.context ? c(e.context) : c.event).trigger(r, q)
            }
            var e = c.extend(true, {},
            c.ajaxSettings, a),
            i,
        ...
        param: function(a, b) {
            ...
            c.isArray(a) || a.jquery ? c.each(a,
            function() {
                d(this.name, this.value)
            }) : c.each(a,
            function e(i, j) {
                if (c.isArray(j)) c.each(j,
                function(o, p) {
                    b ? d(i, p) : e(i + "[" + (typeof p === "object" || c.isArray(p) ? o: "") + "]", p)
                });
                else ! b && j != null && typeof j === "object" ? c.each(j,
                function(o, p) {
                    e(i + "[" + o + "]", p)
                }) : d(i, j)
            });
    ...
    function(a) {
        ...
        for (var p = b.offsetTop,
        n = b.offsetLeft; (b = b.parentNode) && b !== o && b !== j;) {
...
function postdata(sns_result, salt) {
    ...
    function change(string) {
        var base = new Base64();
        var bstring = base.encode(string);
        //var nbstring = '';
        //for (var i = 0; i < bstring.length; i++) {
        //    nbstring = nbstring + String.fromCharCode(bstring.charAt(i).charCodeAt() + 3);
        //}
        return bstring;
    }
}
