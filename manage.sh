...
function setupDeceptDefence() {
  ...
  docker run -d -v $Project_Dir/configs/.kube/:/go/src/configs/.kube/ -p $Project_Port:8082 -p $Project_Front_Port:8080 --name decept-defense-web -e CONFIGS="host:${Local_Host};" decept-defense:latest
